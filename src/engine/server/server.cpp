...
int CServer::Init()
{
	...
	SetFireDelay(INFWEAPON_LOOPER_RIFLE, GetFireDelay(INFWEAPON_RIFLE) / 3.0f);
	...
	SetFireDelay(INFWEAPON_MAGICIAN_GRENADE, GetFireDelay(INFWEAPON_GRENADE) / 2.0f);
	...
	SetFireDelay(INFWEAPON_MAGICIAN_RIFLE, GetFireDelay(INFWEAPON_RIFLE));
	...
	SetAmmoRegenTime(INFWEAPON_LOOPER_RIFLE, 100);
	SetAmmoRegenTime(INFWEAPON_SOLDIER_GRENADE, 7000);
	SetAmmoRegenTime(INFWEAPON_HERO_GRENADE, 1000);
	...
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_RIFLE, 4000);
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_GRENADE, 4000);
	...
	SetMaxAmmo(INFWEAPON_MAGICIAN_RIFLE, 10);
